...
$('.search-form form').submit(function(){
	$('#proposal-status-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <div class="row">
                            <div class="col-md-6"><h4 class="card-title">Manage Proposal Status</h4></div>
                            <div class="col-md-6"><a href="<?php echo Yii::app()->request->baseUrl; ?>/proposalStatus/create">
                                    <input class="btn btn-rose" type="button" name="yt0" value="Add Proposal Status " style="float:right;">
                                </a>
                            </div>
                        </div>
