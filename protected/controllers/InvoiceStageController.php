...
class InvoiceStageController extends Controller
{
	/**
	 ...
	 * @return InvoiceStage the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=InvoiceStage::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param InvoiceStage $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='invoice-stage-form')
		{
