...
/**
 * This is the model class for table "espl_role".
 *
 * The followings are the available columns in table 'espl_role':
 * @property integer $id
...
class EsplRole extends CActiveRecord
{
	 ...
	 */
    public $status_name;//assignn the anothe table column name
	...
	public function rules()
	{
		...
		return array(
			array('role_name, permission', 'required'),
		//	array('permission', 'numerical', 'integerOnly'=>true),
			array('role_name', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, role_name, permission, created_date, modified_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
       ...
       // $criteria->addCondition('i.id = 2');//this is where condition
        ...
        $models = EsplRole::model()->find($criteria);
	 ...
	 * @return EsplRole the static model class
	 */
