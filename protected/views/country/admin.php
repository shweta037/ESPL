                ...
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"><a href="<?php echo Yii::app()->request->baseUrl; ?>/country/create">
                                    <input class="btn btn-rose" type="botton" name="yt0" value="Add Country" style="float:right;">
                                </a>
                            </div>
                        </div>
