...
class ProjectRegionController extends Controller
{
	 ...
	 * @return ProjectRegion the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ProjectRegion::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ProjectRegion $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='project-region-form')
		{
