                ...
                <div class="card">
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"><a href="<?php echo Yii::app()->request->baseUrl; ?>/ProductMaster/create">
                                    <input class="btn btn-rose" type="button" name="yt0" value="Add Product" style="float:right;">
                                </a>
                            </div>
                        </div>
                    </div>
