    ...
    <h4 class="card-title">Create ProposalStatus</h4>
    </div>
    ...
    <?php echo $form->textField($model,'status_name',array('size'=>60,'maxlength'=>255,'class'=>"form-control", 'id'=>"status_name",'required'=>"true")); ?>
