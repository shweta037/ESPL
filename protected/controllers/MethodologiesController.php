...
class MethodologiesController extends Controller
{
	/**
	 ...
	 * @return Methodologies the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Methodologies::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Methodologies $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='methodologies-form')
		{
